...
public class ESTest {
    ...
    public void getClient() throws Exception {
        ...
        // 2 连接集群，getByName是服务器地址IP或host
        client = new PreBuiltTransportClient(settings);
        client.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("hd104"), 9300));
    ...
    /**
     * 查询所有（matchAllQuery，不建议使用）
     */
    @Test
    public void matchAllQuery() {
        // 1 执行查询，matchAllQuery 查询所有数据
    ...
    /**
     * 对所有字段分词查询（queryStringQuery 设置查询条件，相当于like，搜索所有字段）
     */
    @Test
    public void query() {
        // 1 条件查询
